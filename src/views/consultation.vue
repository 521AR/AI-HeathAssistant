        ...
        <div class="sidebar">
            ...
            <div class="ai-assistant-info">
                <div class="breathing-circle">
                    <el-image style="width: 25px; height: 25px;" :src="iconUrl" alt="AI助手" fit="contain" />
                </div>
            ...
            <div class="emotion-garden">
                ...
                <div class="emotion-info">
                    ...
                    <div class="emotion-score">得分</div>
                </div>
                <div class="warm-tips">
                        ...
                        <div class="session-info">
                            <div class="session-title">
                                ...
                                <div class="session-preview">
                                    {{ session.lastMessage ? session.lastMessage.content : '无消息' }}
                                </div>
                ...
                <div class="message-item ai-message" v-if="messages.length === 0">
                    ...
                    <div class="message-content">
                        <div class="message-bubble">
                            <p>您好，我是您的AI心理健康助手，很高兴陪伴您，为您提供温暖的心理支持。请告诉我，今天您的感觉怎么样？有什么想要分享的么？</p>
                        </div>
            ...
            <div class="chat-input">
                <div class="input-container">
                    ...
                    <div class="input-footer">
                        <span>按Enter发送，Shift+Enter换行发送</span>
                        <span>{{ userMessage.length }}/500</span>
                    </div>
                </div>
                <el-button class="send-btn" @click="sendMessage"
                    :disabled="!userMessage.trim() || userMessage.length > 500" type="primary">
                    <el-icon>
                        <Promotion />
                    </el-icon>
                </el-button>
                ...
                if (ok && payload.data && payload.data.content) {
                    ...
                    if (aiMessage) {
                        ...
                        messages.value[messages.value.length - 1] = {
                            ...aiMessage,
                            content: aiMessage.content + payload.data.content
                        }
                    }
                } else if (!ok) {
                    //错误回复的显示
...
const getSessionPage = () => {
    ...
    getSessionList({
        ...
        ElMessage.error(error.msg || "获取会话列表失败，请稍后重试")
    })
}
//获取会话列表
const handleSessionClick = (session) => {
    ...
    getSessionDetail(session.id).then(res => {
        ...
        ElMessage.error(error.msg || "获取会话详情失败，请稍后重试")
    })
    //获取会话的情绪分析
...
const handleDeleteSession = (sessionId) => {
    ...
    deleteSession(sessionId).then(res => {
        ...
        ElMessage.error(error.msg || "删除会话失败，请稍后重试")
    })
