        ...
        <div class="detail-section" v-else>
          ...
          <div class="ai-analysis-result">
            <el-descriptions :column="2" border>
              ...
              <el-descriptions-item label=" 情绪强度">
                <el-progress :percentage="0" :color="getEmotionScoreColor(0)" :stroke-width="8" />
              </el-descriptions-item> 
              <el-descriptions-item label=" 风险等级">
                <el-tag type="info">-</el-tag>
              </el-descriptions-item> 
            ...
            <div class="ai-suggestion-section">
              <h5>专业建议：</h5>
              <div class="suggestion-content">无</div>
            </div>
            <div class="ai-risk-section">
              <h5>风险描述：</h5>
              <div class="risk-content">无</div>
            </div>
            <div class="ai-improvement-section">
              <h5>改善建议:</h5>
              <p>无</p>
...
const formItem = [
  ...
  { comp:'select',prop:'moodScreRange',label:'情绪评分',placeholder:'请选择评分范围',options:[{
    value:'1-3',label:'低分(1-3)'
  },{
    value:'4-6',label:'中分(4-6)'
  },{
    value:'7-10',label:'高分(7-10)'
  }]
}]
...
const viewSessionDetail = (row) => {
  ...
  if(row.hasAiEmotionAnalysis && row.aiEmotionAnalysis){
    try {
