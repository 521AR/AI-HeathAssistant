...
const aiData = ref({ systemOverview: { totalUsers: 0, activeUsers: 0, totalDiaries: 0, totalSessions: 0, avgMoodScore: 0, todayNewUsers: 0, todayNewDiaries: 0, todayNewSessions: 0 }, consultationStats: { totalSessions: 0, avgDurationMinutes: 0 } })
